...
| Withheld | Why |
|---|---|
| Deployment, validation and handover scripts | They publish the mainnet role topology and the handover sequence. To be revisited after launch. |
| The off-chain keeper | Operational infrastructure carrying private-relay and bundle-feed integration detail. Not required to review the protocol. |
