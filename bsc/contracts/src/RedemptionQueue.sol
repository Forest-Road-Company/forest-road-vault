...
///         superseding ADR-0018 section 2 - see the role's NatSpec) and chunked (`maxRequests`
...
///
///         section 1.3 INVARIANTS OWED HERE (encoded in RedemptionQueueInvariants):
    ...
    IRedemptionQueue
{
    ...
    ///
    ///      SUPERSEDES ADR-0018 section 2. See `Roles.SETTLEMENT_KEEPER_ROLE` for the liveness posture
