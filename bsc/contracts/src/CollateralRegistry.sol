    ...
    IAccrualExposureRegistry
{
    ...
    /// @notice Removes face already written down by the bound reserve's protected rounding operation.
    /// @dev Only the permanent source may continue while busy. Ordinary credit roles retain their idle gate.
