...
///         a liquidity budget snapshotted per settlement. The section 1.3 queue invariants -
...
interface IRedemptionQueue {
    ...
    ///      predicate is not reconstructable from the log (CLAUDE.md section 3.1), because `withheld` is
    ...
    ///         manipulable while permissionless (D7-01). Supersedes ADR-0018 section 2.
