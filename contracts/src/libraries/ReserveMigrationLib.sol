...
import {ReserveManager as Native} from "../ReserveManager.sol";
...
library ReserveMigrationLib {
    ...
    function _asset(Native.ReserveStorage storage native, uint256) private view returns (address, uint256) {
        return (address(native.usdcToken), ReserveStorageLib.USDC_SCALE);
    }
