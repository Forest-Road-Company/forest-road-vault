...
That distinction was not obvious. The first attempt applied the floor check on every exit —
the intuitive fix — and **the stateful invariant suite rejected it** for denying settlement
