 ...
 * product running head beneath it, matching the Vault decks' running
 * foot ("FOREST ROAD VAULT"). FRAM branding was retired from the site
 * in September 2026.
 */
        ...
        <div className="flex flex-col gap-10 lg:flex-row lg:justify-between">
          ...
          <div className="grid grid-cols-2 gap-x-8 gap-y-8 text-[13px] sm:grid-cols-3 sm:gap-y-2 lg:gap-x-16 [&>div]:min-w-max">
            <div className="space-y-0.5">
              ...
              <Link href="/curators" className="block py-1 text-on-navy-muted hover:text-on-navy">
                Curators
              </Link>
            ...
            <div className="space-y-0.5">
              ...
              <a
                href="https://discord.com/invite/swXQWqrAgf"
                target="_blank"
