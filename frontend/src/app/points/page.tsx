    ...
    >
      ...
      <Section tone="navy">
        <SectionHead
          ...
          lede="A curator is a first-loss investor: capital that absorbs losses ahead of depositors and earns a fixed 12.5% a year while committed. All three source multiples are bounded and governance-tunable. Changes apply going forward, never retroactively."
        />
        <div className="mt-12">
          <KpiBand
